    ...
    return (
        <div className='w-full max-w-md mx-auto'>
            ...
            <Label className="text-lg font-semibold mb-2 block mt-4">
             ...
             <div className="border-2 border-dashed  rounded-lg p-4 text-wrap" onDragOver={handleDragOver}  onDrop={handleDrop}>
            <Input type="file" ref={inputref} onChange={handleImagefileChange}  id="image-upload" className='hidden'/>
